...
.button:hover span:after {
  ...
  right: 0;
    ...
    <body style="padding:150px; style="margin-top:100px;">
            <form  method="POST" action="/signupngo1">
                <span class="input"></span>
    <center><img src="https://image.flaticon.com/icons/png/512/295/295128.png" height="200px" width="200px;"></center>
    <div class="Register">
    <h1>Register</h1>
...
<div class="input-container">
 ...
 <label for="name"><b style="font-size: 20px;" style="text-align:justify; ">Full Name</b></label>
<div class="input-container">
    <i class="fa fa-envelope icon"></i>
    &nbsp; <input type="text" placeholder="Enter full name" name="nname" required></div>
  <span class="input"></span>
<label for="number"><b>Phone Number</b></label>
  <div class="input-container">
    <i class="fa fa-user icon"></i>
  <input type="text" name="mobile" placeholder="Enter Phone Number" title="Format: Xx[space]Xx (e.g. Alex Cican)">
      </div>
  <label for="school name"><b>School Affiliated</b></label>
  <div class="input-container">
    <i class="fa fa-user icon"></i>
  <input type="text" name="school" placeholder="Enter School Affiliated">
      </div>
  <label for="hospital name"><b>Hospital Affiliated</b></label>
  <div class="input-container">
    <i class="fa fa-user icon"></i>
  <input type="text" name="hospital" placeholder="Enter Hospital Affiliated">
      </div>
...
"float=right;"><span>Sign up</span></button>
 ...
 <br>
  ...
  <div class="container signin">
    <p>Already have an account? <a href="http://localhost:4555/">Log in</a>.</p>
  </div>
